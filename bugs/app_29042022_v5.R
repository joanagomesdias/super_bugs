...
hosp.list <- list("Hospital de Santa Maria Maior, E.P.E. - Barcelos",	
                  ...
                  "Instituto Português de Oncologia, E.P.E. - Coimbra",
                  ...
                  "Instituto Português de Oncologia, E.P.E. - Lisboa",
                  ...
                  "Instituto Português de Oncologia, E.P.E. - Porto",
                  "Hospital Espírito Santo, E.P.E. - Evora",
